...
public partial class Calendar : ContentView
	{
		...
		public static readonly BindableProperty SelectedBackgroundColorProperty =
			BindableProperty.Create(nameof(SelectedBackgroundColor), typeof(Color), typeof(Calendar), Colors.Gray,
		...
		{
			if (newValue == oldValue) return;
			buttons.FindAll(b => b.IsSelected).ForEach(b => b.BackgroundColor = (newValue != Colors.Gray ?  newValue : Colors.Transparent));
		}
		...
		public static readonly BindableProperty SelectedTextColorProperty =
			BindableProperty.Create(nameof(SelectedTextColor), typeof(Color), typeof(Calendar), Colors.Gray,
		...
		{
			if (newValue == oldValue) return;
			buttons.FindAll(b => b.IsSelected).ForEach(b => b.TextColor = (newValue != Colors.Gray ?  newValue: Colors.Black));
		}
		...
		protected void SetButtonSelected(CalendarButton button, SpecialDate special)
		{
			Device.BeginInvokeOnMainThread(() =>
			{
				...
				button.BackgroundColor = SelectedBackgroundColor != Colors.Gray ? SelectedBackgroundColor : (special != null && special.BackgroundColor != default(Color) ? special.BackgroundColor : defaultBackgroundColor);
				button.TextColor = SelectedTextColor != Colors.Gray ? SelectedTextColor : (special != null && special.TextColor != default(Color) ? special.TextColor : defaultTextColor);
