...
public class MainActivity : MauiAppCompatActivity, IOnSuccessListener
{
    ...
    protected override void OnCreate(Bundle savedInstanceState)
    {
        ...
        iCampus.MobileApp.App.DeviceID = Android.Provider.Settings.Secure.GetString(
    ...
    public void OnSuccess(Java.Lang.Object result)
    {
        ...
        else
        {
            ...
            if (result is Java.Lang.Object tokenObject)
                iCampus.MobileApp.App.RefreshedToken =
                    tokenObject.Class.GetMethod("getToken").Invoke(tokenObject).ToString();
        }
    }
