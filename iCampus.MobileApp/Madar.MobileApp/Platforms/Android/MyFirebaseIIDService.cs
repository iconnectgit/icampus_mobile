...
public class MyFirebaseIIDService : FirebaseMessagingService
{
    ...
    private void SendNotification(string messageBody, IDictionary<string, string> data, string title)
    {
        try
        {
            ...
            var notification_ID = Guid.NewGuid().GetHashCode();
            ...
            var pendingActivityIntent =
                PendingIntent.GetActivity(this, MainActivity.NOTIFICATION_ID, intent, pendingIntentFlags);

            var notificationBuilder = new NotificationCompat.Builder(this, MainActivity.CHANNEL_ID)
                .SetSmallIcon(ResourceConstant.Drawable.madar_icon_logo).SetContentTitle(title)
