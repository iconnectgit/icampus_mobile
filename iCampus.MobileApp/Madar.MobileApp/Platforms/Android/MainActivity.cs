...
public class MainActivity : MauiAppCompatActivity, IOnSuccessListener
{
    ...
    protected override void OnCreate(Bundle savedInstanceState)
    {
        ...
        iCampus.MobileApp.App.DeviceID = Android.Provider.Settings.Secure.GetString(Android.App.Application.Context.ContentResolver, Android.Provider.Settings.Secure.AndroidId);
    ...
    public void OnSuccess(Java.Lang.Object result)
    {
        ...
        else
        {
            ...
            {
                iCampus.MobileApp.App.RefreshedToken = tokenObject.Class.GetMethod("getToken").Invoke(tokenObject).ToString();
            }
        }
    }
